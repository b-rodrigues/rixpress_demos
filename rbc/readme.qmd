...
Of course, we could have simply used the RBC model itself for the predictions, but
again, this is a toy example. Also, using something like an ARIMA model would
likely make more sense, but again, don't focus too much on the "insides" of the
code.
